...
def extract_icons(exe_path, sizes=None):
    ...
    icon_sizes = sizes or (16, 24, 32, 48, 96, 256)
    icon_lookup = ctypes.windll.user32.LookupIconIdFromDirectoryEx
    create_icon = ctypes.windll.user32.CreateIconFromResourceEx

    for icon_size in icon_sizes:
        icon_name = icon_lookup(mem_icon_dir, True, icon_size, icon_size, 0x00000000)
        ...
        hIconRet = create_icon(binary_data, size, True, 0x00030000, 0, 0, 0x00000000)
        ...
        bits = (bminfo.bmWidth, bminfo.bmHeight, group_name, icon_name)
        output_name = "icon-%03dx%03d-%05d-%03d.bmp" % bits
        hbmp.SaveBitmapFile(hcdc, OUT_DIR / output_name)
